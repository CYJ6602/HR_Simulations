...
then
    ...
    UCHiCARI input/mo83_$1keV_$2evt_lowlevel.mac
    ...
    Gamma_coincidence -i root/mo83_$1keV_$2evt_lowlevel.root -o coin/mo83_$1keV_$2evt_lowlevel.root 
    
else
    echo "usage ./sim_minos.sh energy events"
fi
